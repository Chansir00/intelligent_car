...
#define ENCODER_QUADDEC2                 (TIM6_ENCODER)                         // 正交编码器对应使用的编码器接口
#define ENCODER_QUADDEC_A2               (TIM6_ENCODER_CH1_P20_3)               // A 相对应的引脚
#define ENCODER_QUADDEC_B2               (TIM6_ENCODER_CH2_P20_0)               // B 相对应的引脚
